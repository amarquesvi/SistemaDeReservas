        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          // criei as variáveis p receber os dados do formulário
           ...
           ManterUsuarios mu = new ManterUsuarios();
            ...
            //inserindo o obj usuario no banco de dados
           mu.inserir(u);
           
            //Armazena o nome do usuario na requisição com a chave "ok"
           request.setAttribute("ok", u.getNome());
           
            //Obtém o requestDispatcher para encaminhar a  requisição e resposta para a paginaLogin
           RequestDispatcher rd = (RequestDispatcher) request.getRequestDispatcher("paginaLogin.jsp");
